...
import org.smlite.rest.providers.VendorEntityProvider;


/**
 * The sample Direct servlet allows unfettered access to entity URLs within the system
 * and provides the EB REST access
 * 
 * @author Aaron Zeckoski (aaron@caret.cam.ac.uk)
 */
public class SMLiteDirectServlet extends DirectServlet {
    ...
    protected void startProviders(EntityProviderManager entityProviderManager) {
        this.entityProviders = new Vector<AbstractAutoRegisteringProvider>();
    
        AbstractAutoRegisteringProvider epm = new VendorEntityProvider(entityProviderManager) ;
        this.entityProviders.add( epm);
    }
